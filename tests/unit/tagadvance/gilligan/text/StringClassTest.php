...
class StringClassTest extends TestCase
{
    ...
    public function testValueOfInteger()
    {
        $value = StringClass::valueOf(0);
        $this->assertNotNull($value);
    }

    public function testToNativeValueWithRawString()
    {
        $expected = 'foo';
    ...
    public function testToNativeValueWithStringClass()
    {
        $expected = 'foo';
    ...
    public function testConcatenateFooAndBar()
    {
    ...
    public function testAlphabetContainsLMNOP()
    {
    ...
    public function testAlphabetDoesNotContainZero()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
    ...
    public function testAlphabetDoesNotContainCapitalABC()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
    ...
    public function testAlphabetEquals()
    {
    ...
    public function testAlphabetEqualsCaseSensitive()
    {
        $lowerCaseAlphabet = 'abcdefghijklmnopqrstuvwxyz';
    ...
    public function testAlphabetEqualsCaseInsensitive()
    {
        $lowerCaseAlphabet = 'abcdefghijklmnopqrstuvwxyz';
        $upperCaseAlphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
        $alphabet = new StringClass($lowerCaseAlphabet);
    ...
    public function testAlphabetToUpperCase()
    {
        $lowerCaseAlphabet = 'abcdefghijklmnopqrstuvwxyz';
        $upperCaseAlphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
        $alphabet = new StringClass($lowerCaseAlphabet);
    ...
    public function testAlphabetToLowerCase()
    {
        $lowerCaseAlphabet = 'abcdefghijklmnopqrstuvwxyz';
        $upperCaseAlphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
    ...
    public function testAlphabetStartsWithABC()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
    ...
    public function testLowerCaseAlphabetDoesNotStartWithUpperCaseABC()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
        $actual = $alphabet->startsWith('ABC');
        $this->assertFalse($actual);
    ...
    public function testAbcRepeatingStartsWithAbcAtOffset3()
    {
    ...
    public function testAbcRepeatingDoesNotStartWithAbcAtOffset2()
    {
        $alphabet = new StringClass('abcabcabc');
    ...
    public function testAlphabetEndsWithXYZ()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
    ...
    public function testLowerCaseAlphabetDoesNotEndWithUpperCaseXYZ()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
    ...
    public function testPositionOfAbcInAbcRepeating()
    {
    ...
    public function testPositionOfAbcInAbcRepeatingStartingAtIndex5()
    {
        $alphabet = new StringClass('abcABCabcABCabcABC');
    ...
    public function testLastPositionOfAbcInAbcRepeating()
    {
        $alphabet = new StringClass('abcABCabcABCabcABC');
    ...
    public function testLastPositionOfAbcInAbcRepeatingStartingAtIndex9()
    {
        $alphabet = new StringClass('abcABCabcABCabcABC');
    ...
    public function testAStringIsNotEmpty()
    {
        $string = new StringClass(' ');
        $actual = $string->isEmpty();
        $this->assertFalse($actual);
    ...
    public function testEmptyStringLengthIs0()
    {
    ...
    public function testAlphabetLengthIs26()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
        $actual = $alphabet->length();
    ...
    public function testAbcXyzRepeatingReplaceAllAbcWithFoo()
    {
    ...
    public function testAbcXyzRepeatingReplaceAllAbcWithFooLimit0()
    {
    ...
    public function testAbcXyzRepeatingReplaceAllAbcWithFooLimit1()
    {
        $alphabet = new StringClass('abcXYZABCxyzabcXYZABCxyz');
    ...
    public function testReverseAlphabet()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
    ...
    public function testExplodeOnCSV()
    {
    ...
    public function testSplitOnCSV()
    {
        $string = new StringClass('1,2,3');
    ...
    public function testSubstringofAlphabetFromIndex7ToIndex10()
    {
        $alphabet = new StringClass('abcdefghijklmnopqrstuvwxyz');
    ...
    public function testPadWithOddNumberOfCharacters()
    {
    ...
    public function testPadWithEvenNumberOfCharacters()
    {
        $string = new StringClass('1');
    ...
    public function testPadWithLengthLessThanNumberOfCharacters()
    {
        $expected = '123456789';
        $string = new StringClass($expected);
    ...
    public function testPadLeft0WithFour1s()
    {
        $expected = '00001';
        $string = new StringClass('1');
    ...
    public function testPadLeftWithLengthLessThanNumberOfCharacters()
    {
        $expected = '123456789';
        $string = new StringClass($expected);
    ...
    public function testPadRight0WithFour1s()
    {
        $expected = '10000';
        $string = new StringClass('1');
    ...
    public function testPadRightWithLengthLessThanNumberOfCharacters()
    {
        $expected = '123456789';
        $string = new StringClass($expected);
        $string = $string->padRight('0', $length = 5);
