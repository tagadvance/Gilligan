...
final class FileMode
{
     ...
     * @var string
     */
    public const WRITE_ONLY_TRUNCATE = 'w';
     ...
     * @var string
     */
    public const WRITE_ONLY_MUST_NOT_EXIST = 'x';
     ...
     * @var string
     */
    public const READ_WRITE_MUST_NOT_EXIST = 'x+';
     ...
     * @var string
     */
    public const WRITE_ONLY_ADVISORY = 'c';
     ...
     * @var string
     */
    public const READ_WRITE_ADVISORY = 'c+';
